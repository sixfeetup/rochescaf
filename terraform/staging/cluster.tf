module "cluster" {
  source                 = "../modules/base"
  environment            = "staging"
  cluster_name           = "rochescaf-staging"
  domain_name            = "staging.roche.scaf.sixfeetup.com"
  api_domain_name        = "api.staging.roche.scaf.sixfeetup.com"
  cluster_domain_name    = "k8s.staging.roche.scaf.sixfeetup.com"
  argocd_domain_name     = "argocd.staging.roche.scaf.sixfeetup.com"
  prometheus_domain_name = "prometheus.staging.roche.scaf.sixfeetup.com"
